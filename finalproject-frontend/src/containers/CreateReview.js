      ...
      <div className="inputContainer">
        <form onSubmit={(e) => submitReview(e)}>
          <div className="formWrapper">
            <label>What product are you reviewing?</label>
            <input
              type="text"
              name="reviewTitle"
              placeholder="Title"
          ...
          <div className="formWrapper">
            <label>How do you feel about this product?</label>
            <input
              type="text"
              name="reviewText"
              placeholder="Text"
              className="inputBar && reviewInput"
            />
          </div>
          <button onClick={refreshPage} type="submit" className="submitButton">
            Submit Review
          </button>
        </form>
      </div>
